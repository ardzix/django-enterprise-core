...
class Paypal(BaseModelGeneric):
    ...
    payer_id = models.CharField(max_length=40, blank=True, null=True)
    create_time = models.CharField(max_length=40, blank=True, null=True)
    update_time = models.CharField(max_length=40, blank=True, null=True)
