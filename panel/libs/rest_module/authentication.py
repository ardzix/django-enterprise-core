...
class IsOwnerAuthenticated(IsAuthenticated):
    ...
    def has_permission(self, request, view):
        is_authenticated = super(IsOwnerAuthenticated, self).has_permission(request, view)
...
class IsCreatorAuthenticated(IsAuthenticated):
    ...
    def has_permission(self, request, view):
        is_authenticated = super(IsCreatorAuthenticated, self).has_permission(request, view)
